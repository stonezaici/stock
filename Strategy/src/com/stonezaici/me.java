...
public class me extends JFrame {
	...
	public static void main(String[] args) throws ParseException {
		String fileDir = "D:\\Program Files (x86)\\T0002\\test\\";
		String hushengZhiShuPath = "D:\\Program Files (x86)\\T0002\\test\\SZ399300.TXT";
...
//								ets[seriesNCount]=price[h][1].substring(0,4)+"-"+price[h][1].substring(4,6)+"-"+price[h][1].substring(6,8);
			...
			//			write.newLine();
				...
				//				write.newLine();
					...
					//以下写入 正常卖出的相关信息==================================
//					write.write(sell.get(k)[4]);//A'时间
//					write.write("	");
//					write.write(sell.get(k)[0]);//A'收盘价
//					write.write("	");
//					write.write(sell.get(k)[9]);//B'时间
//					write.write("	");
//					write.write(sell.get(k)[1]);//B'收盘价
//					write.write("	");
//					write.write(sell.get(k)[10]);//C'时间
//					write.write("	");
//					write.write(sell.get(k)[2]);//C'收盘价
//					write.write("	");
//					write.write(sell.get(k)[5]);//D'时间
//					endTime = new SimpleDateFormat("yyyy-MM-dd").parse(sell.get(k)[5]);
//					int diff=(int) ((endTime.getTime()-startTime.getTime())/(24*60*60*1000));
//					//System.out.println(endTime.getTime()+"减去"+startTime.getTime()+" "+diff);
//					totalholdtime=totalholdtime+diff;
//					write.write("	");
//					write.write(sell.get(k)[3]);//D'收盘价
//					write.write("	");
