...
public class chuangye extends JFrame {
	...
	public static void main(String[] args) throws ParseException {
		String fileDir = "D:\\export2\\";
		String chuangyeZhiShuPath = "D:\\export2\\SZ399006.TXT";
...
//		int zhiyingCount=0; //止盈交易数
	...
	//以下是创建输出数据
		...
		fileout =new File("D:\\newwirthoutput\\"+"chuangye__日线—"+nowdate+".txt");
		if (!fileout.exists()) {             
			try {
...
//				write.write("盈利");
		...
		try{	
			...
			FileReader filereader=new FileReader(chuangyeZhiShuPath);//上证50指数数据的存储文件
