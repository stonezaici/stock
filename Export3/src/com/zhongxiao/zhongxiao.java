...
public class zhongxiao extends JFrame {
	...
	public static void main(String[] args) throws ParseException {
		String fileDir = "D:\\export3\\";
		String zhongxiaoZhiShuPath = "D:\\export3\\SZ399005.TXT";
...
//		int zhiyingCount=0; //止盈交易数
	...
	//以下是创建输出数据
		...
		fileout =new File("D:\\newwirthoutput\\"+"zhongxiao__日线—"+nowdate+".txt");
		if (!fileout.exists()) {             
			try {
...
//				write.write("盈利");
		...
		try{	
			...
			FileReader filereader=new FileReader(zhongxiaoZhiShuPath);//上证50指数数据的存储文件
